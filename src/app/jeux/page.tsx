...
const GAMES = [
  ...
  },
  {
    ...
    desc: "Révélez les étoiles sur une grille 5×5 sans sauter sur une bombe. Encaissez à tout moment.",
    href: "/jeux/mines",
    icon: Bomb,
    badge: "Bientôt",
  ...
  },
  {
    id: "cases",
    title: "Case Opening",
    tagline: "Coffres & Loot",
    desc: "Faites défiler la roulette d'items et décrochez des cosmétiques ou récompenses exclusives.",
    href: "/shop",
    icon: PackageOpen,
    badge: "Disponible",
    badgeColor: "bg-emerald-500/20 text-emerald-400 border-emerald-500/30",
