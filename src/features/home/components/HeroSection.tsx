...
export default function HeroSection() {
  ...
  return (
    <section className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] text-center px-4 pt-20">
      ...
      >
        <motion.h1 variants={itemVariants} className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-outfit font-black mb-6 tracking-tight leading-[1.1] text-balance" style={{ color: 'var(--text-color)' }}>
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 mt-8 w-full px-4 sm:px-0">
