...
export default function HeroSection() {
  ...
  return (
    <section className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] text-center px-4 pt-20">
      ...
      >
        <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-outfit font-black mb-6 tracking-tight text-balance" style={{ color: 'var(--text-color)' }}>
          Bienvenue sur le <span style={{ color: 'var(--logo-end)' }}>Paranoia SMP</span>
        </motion.h1>
        
        <motion.p variants={itemVariants} className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-inter font-medium text-balance" style={{ color: 'var(--nav-item-color)' }}>
          Venez découvrir l'univers du Paranoia SMP. 
          Faites vous des Amis ou collectionnez des boosters.
        </motion.p>
        
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-5 mt-8">
          <a href="https://discord.gg/paranoiasmp" target="_blank" rel="noopener noreferrer" className="btn-neo-primary group">
          ...
          <Link href="/cards" className="btn-neo-secondary group">
